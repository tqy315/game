...
class UserProfileAdmin(admin.ModelAdmin):
    list_display = ['user', 'nickname', 'total_points', 'total_games', 'best_time', 'created_at']
    search_fields = ['user__username', 'nickname']


@admin.register(GameRecord)
class GameRecordAdmin(admin.ModelAdmin):
    list_display = ['user', 'theme_name', 'subtopic_name', 'difficulty', 'time_spent', 'moves', 'score', 'completed_at']
